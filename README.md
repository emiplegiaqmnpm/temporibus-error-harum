# @emiplegiaqmnpm/temporibus-error-harum

> forked from [@emiplegiaqmnpm/temporibus-error-harumode](https://www.npmjs.com/package/@emiplegiaqmnpm/temporibus-error-harumode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@emiplegiaqmnpm/temporibus-error-harumode/issues/300).

[![npm version](https://img.shields.io/npm/v/@emiplegiaqmnpm/temporibus-error-harum.svg)](https://www.npmjs.com/package/@emiplegiaqmnpm/temporibus-error-harum)
[![Downloads](https://img.shields.io/npm/dm/@emiplegiaqmnpm/temporibus-error-harum.svg)](https://www.npmjs.com/package/@emiplegiaqmnpm/temporibus-error-harum)
[![Build Status](https://github.com/emiplegiaqmnpm/temporibus-error-harum/workflows/CI/badge.svg)](https://github.com/emiplegiaqmnpm/temporibus-error-harum/actions)
...
```sh
npm install --save-dev eslint @emiplegiaqmnpm/temporibus-error-harum
```
...
```js
const nodePlugin = require("@emiplegiaqmnpm/temporibus-error-harum")
...
💼 [Configurations](https://github.com/emiplegiaqmnpm/temporibus-error-harum#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/emiplegiaqmnpm/temporibus-error-harum#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/emiplegiaqmnpm/temporibus-error-harum#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/emiplegiaqmnpm/temporibus-error-harum#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/emiplegiaqmnpm/temporibus-error-harum#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/emiplegiaqmnpm/temporibus-error-harum#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/emiplegiaqmnpm/temporibus-error-harum#-configs).\
...
`@emiplegiaqmnpm/temporibus-error-harum` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/emiplegiaqmnpm/temporibus-error-harum/releases)
